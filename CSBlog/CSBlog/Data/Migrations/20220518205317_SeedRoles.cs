...
namespace CSBlog.Data.Migrations
{
    public partial class SeedRoles : Migration
    {
        ...
        {
            migrationBuilder.Sql(@$"INSERT INTO [main].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
            VALUES ('{AdminRoleId}', 'Administrator', 'ADMINISTRATOR', null);");
            migrationBuilder.Sql(@$"INSERT INTO [main].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
            VALUES ('{ModeratorRoleId}', 'Moderator', 'MANAGER', null);");
            migrationBuilder.Sql(@$"INSERT INTO [main].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
        ...
        private void SeedUser(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                @$"INSERT [main].[AspNetUsers] ([Id], [FirstName], [LastName], [UserName], [NormalizedUserName], 
...
N'YUPAFWNGZI2UC5FOITC7PX5J7XZTAZAA', N'8e150555-a20d-4610-93ff-49c5af44f749', NULL, 0, 0, NULL, 1, 0)");
        ...
        {
            migrationBuilder.Sql(@$"
        INSERT INTO [main].[AspNetUserRoles]
           ([UserId]
           ,[RoleId])
        VALUES
