...
public class RegisterModel : PageModel
{
  ...
  public class InputModel
  {
    ...
    [StringLength(32, ErrorMessage = "The First Name should be at least 3 characters and not exceed 32 characters.",
      MinimumLength = 3)]
    public string FirstName { get; set; }

    [Required]
    [Display(Name = "Last Name")]
    [StringLength(32, ErrorMessage = "The Last Name should be at least 3 characters and not exceed 32 characters.",
      MinimumLength = 3)]
  ...
  public async Task<IActionResult> OnPostAsync(string returnUrl = null)
  {
    ...
    {
      // var user = CreateUser();
      var user = (BlogUser)CreateUser();
      if (user != null)
      {
        user.FirstName = Input.FirstName;
        user.LastName = Input.LastName;

        List<string> defaultRole = new()
        {
          Constants.Roles.User
        };
        await _signInManager.UserManager.AddToRolesAsync(user, defaultRole);
        // user
